const quiz = require('../../data/brands.json');
...
module.exports = {
    name: 'brands',
    description: 'خمن اسم الشعار التجاري',
    aliases: ['brand', 'علامة', 'شعارات', 'شعار', 'علامات'],
    run: async (message, args, client) => {
        ...
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription("**خمن اسم الشعار او الماركة التالية ?**")
